...
<!-- Überschrift -->
  <div class="container-fluid">
    <div class="jumbotron">
      <p>Correlationplot Spearman wird erstellt. Sie können zur Auswahl zurückkehren.</p>
    </div>
...
exec("/usr/local/bin/Rscript myr4mas.R $in $p $output_path > /dev/null 2>/dev/null &");
