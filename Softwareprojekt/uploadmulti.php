...
form
{
 ...
 <!-- Initialisierung der Buttons -->
  ...
  <form id="uploadForm" action="" method="post" enctype="multipart/form-data">
       ...
       <input type="submit" name="s_button" value="Hochladen" class="btnSubmit"/>
  </form>


  <?php

//Variablen für die Buttonfarbe zurückgesetzt
SESSION_START();
$_SESSION["bool0"] = 0;
$_SESSION["bool1"] = 0;
$_SESSION["bool2"] = 0;
...
<?php
        if (!in_array($extension, $allowedExtensions)) {
            echo "<br />Achtung: Bitte wählen Sie .CEL-Dateien aus <br />";
            echo "<br />";
            ++$i;
...
<?php
    ...
    // Weitergabe der Pfade und Variablen
    //session_start();
